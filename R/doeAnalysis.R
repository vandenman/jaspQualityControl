...
doeAnalysis <- function(jaspResults, dataset, options, ...) {
  ...
  log_time(.doeAnalysisPlotPareto(jaspResults, dependent, options, blocks, covariates, ready))
  log_time(.doeAnalysisPlotEffectNormalDistribution(jaspResults, dependent, options, blocks, covariates, ready))
  log_time(.doeAnalysisPlotQQResiduals(jaspResults, dependent, options, ready))
  log_time(.doeAnalysisPlotHistResiduals(jaspResults, dependent, options, ready))
  log_time(.doeAnalysisPlotFittedVsResiduals(jaspResults, dependent, options, ready))
  log_time(.doeAnalysisPlotResidualsVsOrder(jaspResults, dependent, dataset, options, ready))
  log_time(.doeAnalysisPlotMatrixResidualPlot(jaspResults, dependent, dataset, options, ready))
  log_time(.doeAnalysisPlotContourSurface(jaspResults, dataset, options, dependent, ready))
